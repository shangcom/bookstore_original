    ...
    <c:forEach var="item" items="${goodsMap.bestseller }">
        ...
        <div class="book">
            ...
            <img width="121" height="154"
                 src="${contextPath}/thumbnails.do?goods_id=${item.goods_id}&fileName=${item.goods_fileName}"> <%--썸네일 이미지 표시--%>
        ...
        <c:if test="${goods_count==15   }"> <%--베스트셀러가 15개 이상이면 16번째 이미지에는 more 표시--%>
            <div class="book">
